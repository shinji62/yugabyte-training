...
resource "yba_installer" "install" {
  ...
  depends_on                = [module.r1, module.r2, module.r3, module.vpc-peering-r1-r2, module.vpc-peering-r1-r3, module.vpc-peering-r2-r3]
}
...
resource "yba_cloud_provider" "aws" {
  ...
  name     = "awsProvider"
  regions {
    code              = var.aws_region_1
    name              = var.aws_region_1
  ...
  regions {
    code              = var.aws_region_2
    name              = var.aws_region_2
    security_group_id = module.r2.yugabyte_anywhere_node_security_group_id
    vnet_name         = module.r2.vpc_id
    dynamic "zones" {
      for_each = module.r2.azs
      content {
        code   = zones.value
        name   = zones.value
        subnet = module.r2.private_subnets[zones.key]
      }
    }
  }
  regions {
    code              = var.aws_region_3
    name              = var.aws_region_3
    security_group_id = module.r3.yugabyte_anywhere_node_security_group_id
    vnet_name         = module.r3.vpc_id
    dynamic "zones" {
      for_each = module.r3.azs
      content {
        code   = zones.value
        name   = zones.value
        subnet = module.r3.private_subnets[zones.key]
      }
    }
  }
  aws_config_settings {
